...
public class LogPatternFactory {
    ...
    public Log4jPattern getLog4jPattern(LogType logType, String name, String patternString, boolean isCW) {
        ...
        if ((patternString != null) && (!"".equals(patternString))) {
            ...
            log4jPattern = new Log4jPattern(logType, name, patternString, groupCount, isCW);
        }
