...
public class SecurityEventLog4jPatternParser extends Log4jPatternParser {

    private static final Log4j2Helper LOG = new Log4j2Helper(SecurityEventLog4jPatternParser.class);
    ...
    public SecurityEventLog4jPatternParser(Log4jPattern log4jPattern, Charset charset, Locale locale,
    ...
    protected void processCloudKLogMap(String time, StringBuilder logEntryTextSB, Map<String, Object> fieldMap) {
        ...
        logEntryTextSB.append(String.format(V2_STR_FORMAT, time, thread, pegaThread, "", "", logger, logLevel, "",
                correlationId, ""));
    }
