...
public class LogSystemStartParser {
	...
	public Map<String, String> getSystemStartMap(SystemStart systemStart, Log4jLogEntryModel log4jLogEntryModel) {
		...
		Integer ssBeginIndex = systemStart.getBeginIndex();
		Integer ssEndIndex = systemStart.getEndIndex();

		for (Integer index = ssBeginIndex; index <= ssEndIndex; index++) {

			LogEntry logEntry = logEntryMap.get(index);
