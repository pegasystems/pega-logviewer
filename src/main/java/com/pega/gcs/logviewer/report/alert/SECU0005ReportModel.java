...
public class SECU0005ReportModel extends AlertMessageReportModel {

	private static final long serialVersionUID = -8889727175209305065L;

	private static final Log4j2Helper LOG = new Log4j2Helper(SECU0005ReportModel.class);

	private List<AlertBoxAndWhiskerReportColumn> alertMessageReportColumnList;

	private Pattern pattern;

	public SECU0005ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("SECU0005", thresholdKPI, kpiUnit, alertLogEntryModel);

		String regex = "Invalid thread name detected:(.*)";
	...
	public String getAlertMessageReportEntryKey(AlertLogEntry alertLogEntry, ArrayList<String> logEntryValueList) {
		...
		if (alertMessageReportEntryKey == null) {
			LOG.info("SECU0005ReportModel - Could'nt match - [" + message + "]");
		}
	...
	public static void main(String[] args) {
		...
		String message1 = "A Thread name in a URL contains invalid characters : Invalid thread name detected: CustomerDashboardLBG/$!STANDARD";
