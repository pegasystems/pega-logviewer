...
public class PEGA0048ReportModel extends AlertMessageReportModel {
	...
	public PEGA0048ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("PEGA0048", thresholdKPI, kpiUnit, alertLogEntryModel);
