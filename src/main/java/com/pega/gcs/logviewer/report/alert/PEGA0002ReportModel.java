...
public class PEGA0002ReportModel extends AlertMessageReportModel {
    ...
    public PEGA0002ReportModel(AlertMessage alertMessage, long thresholdKPI, AlertLogEntryModel alertLogEntryModel,
            Locale locale) {
    ...
    public String getAlertMessageReportEntryKey(ArrayList<String> logEntryValueList) {
        ...
        if ("".equals(alertMessageReportEntryKey)) {
            ...
            int lastInputIndex = getLastInputLogEntryColumnIndex();
