...
public class PEGA0085ReportModel extends AlertMessageReportModel {
	...
	public PEGA0085ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("PEGA0085", thresholdKPI, kpiUnit, alertLogEntryModel);
	}
	...
	protected List<AlertBoxAndWhiskerReportColumn> getAlertMessageReportColumnList() {
		...
		if (alertMessageReportColumnList == null) {
			...
			displayName = "Free Disk Space Percent";
			prefColWidth = 500;
