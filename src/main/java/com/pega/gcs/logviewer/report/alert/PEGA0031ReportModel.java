...
public class PEGA0031ReportModel extends AlertMessageReportModel {
	...
	public PEGA0031ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("PEGA0031", thresholdKPI, kpiUnit, alertLogEntryModel);
	}
