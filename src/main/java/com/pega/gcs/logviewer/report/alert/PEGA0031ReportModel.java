...
public class PEGA0031ReportModel extends AlertMessageReportModel {
    ...
    public PEGA0031ReportModel(AlertMessage alertMessage, long thresholdKPI, AlertLogEntryModel alertLogEntryModel,
            Locale locale) {
