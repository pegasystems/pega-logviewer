...
public class PEGA0038ReportModel extends AlertMessageReportModel {
    ...
    public PEGA0038ReportModel(AlertMessage alertMessage, long thresholdKPI, AlertLogEntryModel alertLogEntryModel,
            Locale locale) {
    ...
    protected List<AlertBoxAndWhiskerReportColumn> getAlertMessageReportColumnList() {
        ...
        if (alertMessageReportColumnList == null) {
            ...
            displayName = "Alert Subject (\"Activity Class Name\")";
            prefColWidth = 500;
