...
public class PEGA0003ReportModel extends AlertMessageReportModel {
    ...
    public PEGA0003ReportModel(AlertMessage alertMessage, long thresholdKPI, AlertLogEntryModel alertLogEntryModel,
            Locale locale) {
