...
public class PEGA0003ReportModel extends AlertMessageReportModel {
	...
	public PEGA0003ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("PEGA0003", thresholdKPI, kpiUnit, alertLogEntryModel);
	}
