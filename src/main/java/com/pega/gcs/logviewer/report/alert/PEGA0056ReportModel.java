...
public class PEGA0056ReportModel extends AlertMessageReportModel {
	...
	public PEGA0056ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("PEGA0056", thresholdKPI, kpiUnit, alertLogEntryModel);
	}
	...
	public String getAlertMessageReportEntryKey(AlertLogEntry alertLogEntry, ArrayList<String> logEntryValueList) {
		...
		String alertMessageReportEntryKey = "System-Locks";
