...
public class PEGA0016ReportModel extends AlertMessageReportModel {
	...
	public PEGA0016ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("PEGA0016", thresholdKPI, kpiUnit, alertLogEntryModel);

		String regex = "(.*)(: Attempted to agressively reduce MRU from:|: Successfully reduced MRU)";
	...
	public String getAlertMessageReportEntryKey(AlertLogEntry alertLogEntry, ArrayList<String> logEntryValueList) {
		...
		if (alertMessageReportEntryKey == null) {
			LOG.info("PEGA0016ReportModel - Could'nt match - [" + message + "]");
		}
	...
	public static void main(String[] args) {
		...
		String message1 = "declaratives/declarepages: Attempted to agressively reduce MRU from: 1250 by 650 to 600; actually removed 20 entries leaving ~1230.";
		String message2 = "fua/global: Successfully reduced MRU by 4001 to: 16000.";
