...
public class PEGA0044ReportModel extends AlertMessageReportModel {
	...
	public PEGA0044ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("PEGA0044", thresholdKPI, kpiUnit, alertLogEntryModel);
	...
	public static void main(String[] args) {
		...
		String message1 = "Reached threshold limit for message ID: PEGA0017, will send again after Wed Jul 27 06:37:18 UTC 2016";
