...
public class PEGA0104ReportModel extends AlertMessageReportModel {
    ...
    public PEGA0104ReportModel(AlertMessage alertMessage, long thresholdKPI, AlertLogEntryModel alertLogEntryModel,
            Locale locale) {
    ...
    protected List<AlertBoxAndWhiskerReportColumn> getAlertMessageReportColumnList() {
        ...
        if (alertMessageReportColumnList == null) {
            ...
            displayName = "Alert Subject (\"Long waiting background tasks detected\")";
            prefColWidth = 500;
    ...
    public String getAlertMessageReportEntryKey(ArrayList<String> logEntryValueList) {
        ...
        String alertMessageReportEntryKey = "Long waiting background tasks";
