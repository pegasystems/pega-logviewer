...
public class PEGA0080ReportModel extends AlertMessageReportModel {
    ...
    public PEGA0080ReportModel(AlertMessage alertMessage, long thresholdKPI, AlertLogEntryModel alertLogEntryModel,
            Locale locale) {
    ...
    protected List<AlertBoxAndWhiskerReportColumn> getAlertMessageReportColumnList() {
        ...
        if (alertMessageReportColumnList == null) {
            ...
            displayName = "Alert Subject (\"Column Family - [DataSet Keys]\")";
            prefColWidth = 500;
    ...
    public String getAlertMessageReportEntryKey(String dataText) {
        ...
        if (matches) {
            ...
            String columnFamily = patternMatcher.group(1).trim();
            String queryKeys = patternMatcher.group(2).trim();
