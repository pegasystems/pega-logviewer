...
public class PEGA0043ReportModel extends AlertMessageReportModel {
    ...
    public PEGA0043ReportModel(AlertMessage alertMessage, long thresholdKPI, AlertLogEntryModel alertLogEntryModel,
            Locale locale) {
    ...
    protected List<AlertBoxAndWhiskerReportColumn> getAlertMessageReportColumnList() {
        ...
        if (alertMessageReportColumnList == null) {
            ...
            displayName = "Alert Subject (\"Queue Waiting Time\")";
            prefColWidth = 500;
