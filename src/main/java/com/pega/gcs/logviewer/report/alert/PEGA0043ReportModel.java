...
public class PEGA0043ReportModel extends AlertMessageReportModel {
	...
	public PEGA0043ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("PEGA0043", thresholdKPI, kpiUnit, alertLogEntryModel);
	}
	...
	protected List<AlertBoxAndWhiskerReportColumn> getAlertMessageReportColumnList() {
		...
		if (alertMessageReportColumnList == null) {
			...
			displayName = "​Queue Waiting Time";
			prefColWidth = 500;
	...
	public String getAlertMessageReportEntryKey(AlertLogEntry alertLogEntry, ArrayList<String> logEntryValueList) {
		...
		String alertMessageReportEntryKey = "​Queue waiting time";
