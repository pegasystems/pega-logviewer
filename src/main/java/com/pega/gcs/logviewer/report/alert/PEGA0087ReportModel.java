...
public class PEGA0087ReportModel extends AlertMessageReportModel {
    ...
    public PEGA0087ReportModel(AlertMessage alertMessage, long thresholdKPI, AlertLogEntryModel alertLogEntryModel,
            Locale locale) {
    ...
    protected List<AlertBoxAndWhiskerReportColumn> getAlertMessageReportColumnList() {
        ...
        if (alertMessageReportColumnList == null) {
            ...
            displayName = "Alert Subject (\"Service Type - Service InsName\")";
            prefColWidth = 500;
