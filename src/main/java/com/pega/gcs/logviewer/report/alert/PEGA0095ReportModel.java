...
public class PEGA0095ReportModel extends AlertMessageReportModel {
	...
	public PEGA0095ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("PEGA0095", thresholdKPI, kpiUnit, alertLogEntryModel);
