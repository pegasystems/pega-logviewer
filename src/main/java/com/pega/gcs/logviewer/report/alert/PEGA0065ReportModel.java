...
public class PEGA0065ReportModel extends AlertMessageReportModel {
	...
	public PEGA0065ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("PEGA0065", thresholdKPI, kpiUnit, alertLogEntryModel);
