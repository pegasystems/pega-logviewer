...
public class PEGA0064ReportModel extends AlertMessageReportModel {
    ...
    public PEGA0064ReportModel(AlertMessage alertMessage, long thresholdKPI, AlertLogEntryModel alertLogEntryModel,
            Locale locale) {
    ...
    protected List<AlertBoxAndWhiskerReportColumn> getAlertMessageReportColumnList() {
        ...
        if (alertMessageReportColumnList == null) {
            ...
            displayName = "Alert Subject (\"Component [Strategy] [Data Flow]\")";
            prefColWidth = 500;
