...
public class SECU0002ReportModel extends AlertMessageReportModel {
	...
	public SECU0002ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("SECU0002", thresholdKPI, kpiUnit, alertLogEntryModel);
