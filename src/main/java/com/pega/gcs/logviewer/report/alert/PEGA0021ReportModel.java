...
public class PEGA0021ReportModel extends AlertMessageReportModel {
    ...
    public PEGA0021ReportModel(AlertMessage alertMessage, long thresholdKPI, AlertLogEntryModel alertLogEntryModel,
            Locale locale) {
    ...
    protected List<AlertBoxAndWhiskerReportColumn> getAlertMessageReportColumnList() {
        ...
        if (alertMessageReportColumnList == null) {
            ...
            displayName = "Alert Subject (\"Total shared declarative page memory\")";
            prefColWidth = 500;
