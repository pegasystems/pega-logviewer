...
public class PEGA0004ReportModel extends AlertMessageReportModel {
	...
	public PEGA0004ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("PEGA0004", thresholdKPI, kpiUnit, alertLogEntryModel);
	}
