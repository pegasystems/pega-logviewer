...
public class SECU0007ReportModel extends AlertMessageReportModel {

	private static final long serialVersionUID = -8889727175209305065L;

	private static final Log4j2Helper LOG = new Log4j2Helper(SECU0007ReportModel.class);

	private List<AlertBoxAndWhiskerReportColumn> alertMessageReportColumnList;

	private Pattern pattern;

	public SECU0007ReportModel(long thresholdKPI, String kpiUnit, AlertLogEntryModel alertLogEntryModel) {

		super("SECU0007", thresholdKPI, kpiUnit, alertLogEntryModel);

		String regex = "from IP:(.*). Brute force attack prevention measures were invoked.";
	...
	public String getAlertMessageReportEntryKey(AlertLogEntry alertLogEntry, ArrayList<String> logEntryValueList) {
		...
		if (alertMessageReportEntryKey == null) {
			LOG.info("SECU0006ReportModel - Could'nt match - [" + message + "]");
		}
	...
	public static void main(String[] args) {
		...
		String message1 = "PRPC detected excessive failed login attempts for the user:XXXX from IP:192.168.100.100. Brute force attack prevention measures were invoked.";
