...
public class Log4jLogSystemStartEntry extends Log4jLogEntry {

    private static final long serialVersionUID = -7419303874771737533L;

    public Log4jLogSystemStartEntry(LogEntryKey logEntryKey, ArrayList<String> logEntryValueList, String logEntryText,
