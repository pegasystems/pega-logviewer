...
public class PEGA0058ReportModelTest {
    ...
    public void testGetAlertMessageReportEntryKeyString1() {
        ...
        String dataText = "Reading the interaction history fact record(s) took more than the threshold of 1000 ms : 2797 ms : SQL : SELECT "
                ...
                + ".pySubjectType = 'VFZ-Data-Customer') AND (\"ACTIONTABLE\".pyGroup = 'Xsell') AND (\"ACTIONTABLE\".pyIssue = 'MobileB2C'"
                + ") ) OR ( (\"CUSTOMERTABLE\".pySubjectType = 'VFZ-Data-Customer') AND (\"ACTIONTABLE\".pyGroup = 'Xsell') AND (\"ACTIONTA"
                + "BLE\".pyIssue = 'MobileB2B') ) OR ( (\"CUSTOMERTABLE\".pySubjectType = 'VFZ-Data-Customer') AND (\"ACTIONTABLE\".pyGroup"
                + " = 'Deepsell') AND (\"ACTIONTABLE\".pyIssue = 'MobileB2C') ) OR ( (\"CUSTOMERTABLE\".pySubjectType = 'VFZ-Data-Customer'"
                + ") AND (\"ACTIONTABLE\".pyGroup = 'Deepsell') AND (\"ACTIONTABLE\".pyIssue = 'MobileB2B') ) OR ( (\"CUSTOMERTABLE\".pySub"
                + "jectType = 'VFZ-Data-Customer') AND (\"ACTIONTABLE\".pyGroup = 'Default') AND (\"ACTIONTABLE\".pyIssue = 'MobileB2C') ) "
                + "OR ( (\"CUSTOMERTABLE\".pySubjectType = 'VFZ-Data-Customer') AND (\"ACTIONTABLE\".pyGroup = 'Service') AND (\"ACTIONTABL"
                + "E\".pyIssue = 'MobileB2C') ) OR ( (\"CUSTOMERTABLE\".pySubjectType = 'VFZ-Data-Customer') AND (\"ACTIONTABLE\".pyGroup ="
                + " 'Default') AND (\"ACTIONTABLE\".pyIssue = 'MobileB2B') ) OR ( (\"CUSTOMERTABLE\".pySubjectType = 'VFZ-Data-Customer') A"
                + "ND (\"ACTIONTABLE\".pyGroup = 'Service') AND (\"ACTIONTABLE\".pyIssue = 'MobileB2B') ) OR ( (\"CUSTOMERTABLE\".pySubject"
                + "Type = 'VFZ-Data-Customer') AND (\"ACTIONTABLE\".pyGroup = 'Migration') AND (\"ACTIONTABLE\".pyIssue = 'MobileB2C') ) OR"
                + " ( (\"CUSTOMERTABLE\".pySubjectType = 'VFZ-Data-Customer') AND (\"ACTIONTABLE\".pyGroup = 'Upsell') AND (\"ACTIONTABLE\""
                + ".pyIssue = 'MobileB2C') ) OR ( (\"CUSTOMERTABLE\".pySubjectType = 'VFZ-Data-Customer') AND (\"ACTIONTABLE\".pyGroup = 'M"
                + "igration') AND (\"ACTIONTABLE\".pyIssue = 'MobileB2B') ) OR ( (\"CUSTOMERTABLE\".pySubjectType = 'VFZ-Data-Customer') AN"
                + "D (\"ACTIONTABLE\".pyGroup = 'Upsell') AND (\"ACTIONTABLE\".pyIssue = 'MobileB2B') ) OR ( (\"CUSTOMERTABLE\".pySubjectTy"
                + "pe = 'VFZ-Data-Customer') AND (\"ACTIONTABLE\".pyGroup = 'Retention') AND (\"ACTIONTABLE\".pyIssue = 'MobileB2C') ) OR ("
                + " (\"CUSTOMERTABLE\".pySubjectType = 'VFZ-Data-Customer') AND (\"ACTIONTABLE\".pyGroup = 'Retention') AND (\"ACTIONTABLE\""
    ...
    public void testGetAlertMessageReportEntryKeyString2() {
        ...
        String dataText = "Reading the interaction history fact record(s) took more than the threshold of 1000 ms : 2961 ms : SQL : SELECT "
                ...
                + "('MPER8374849'))  UNION ALL SELECT \"FACTTABLE\".pxFactID, \"FACTTABLE\".pxOutcomeTime, \"FACTTABLE\".pySubjectID, \"FAC"
                ...
                + "CIATIONTABLE\".pyAssociatedID = \"FACTTABLE\".pySubjectID) ) WHERE (\"ASSOCIATIONTABLE\".pySubjectID IN ('MPER8374849'))"
        ...
        org.junit.jupiter.api.Assertions.assertEquals(
                "SELECT pxFactID AS \"pxFactID\", pxOutcomeTime AS \"pxOutcomeTime\", pySubjectID AS \"pySubjectID\", pxInteractionID AS \""
                        ...
                        + "ROM {Class:Data-Decision-IH-Fact} \"FACTTABLE\"  WHERE (\"FACTTABLE\".pySubjectID IN ('MPER8374849'))  UNION ALL"
                        + " SELECT \"FACTTABLE\".pxFactID, \"FACTTABLE\".pxOutcomeTime, \"FACTTABLE\".pySubjectID, \"FACTTABLE\".pxInteract"
                        + "ionID, \"FACTTABLE\".pzActionID, \"FACTTABLE\".pzApplicationID, \"FACTTABLE\".pzChannelID, \"FACTTABLE\".pzConte"
                        + "xtID, \"FACTTABLE\".pzCustomerID, \"FACTTABLE\".pzOperatorID, \"FACTTABLE\".pzOutcomeID, \"FACTTABLE\".pzJourney"
                        + "ID, \"FACTTABLE\".pxDecisionTime, \"FACTTABLE\".pxPriority, \"FACTTABLE\".pxRank, \"FACTTABLE\".pyExternalID, \""
                        + "FACTTABLE\".pyGroupID, \"FACTTABLE\".pyLatitude, \"FACTTABLE\".pyLongitude, \"FACTTABLE\".pyPropensity, \"FACTTA"
                        + "BLE\".pyPartitionKey, \"FACTTABLE\".pyRevenue, \"FACTTABLE\".pyISFactID, \"FACTTABLE\".pyMaxBudget, \"FACTTABLE\""
                        + ".pyTargetBudget, \"FACTTABLE\".pyFulfilled, \"FACTTABLE\".pyWeight, \"FACTTABLE\".IPAddress, \"FACTTABLE\".Reven"
                        + "ue, \"FACTTABLE\".Cost, \"FACTTABLE\".ACCOUNT_ID, \"FACTTABLE\".AnalyticsPriorityWeight, \"FACTTABLE\".SmoothPro"
                        + "pensity, \"FACTTABLE\".IMAGE_NAME, \"FACTTABLE\".CallID, \"FACTTABLE\".ContractIdKey, \"FACTTABLE\".MainProductI"
                        + "D, \"FACTTABLE\".ChildProductID, \"ASSOCIATIONTABLE\".pyAssociationStrength AS \"pyAssociationStrength\", \"ASSO"
                        + "CIATIONTABLE\".pySubjectID AS \"pyAssociatedID\" FROM {Class:Data-Decision-IH-Fact} \"FACTTABLE\"  JOIN {Class:D"
                        + "ata-Decision-IH-Association} \"ASSOCIATIONTABLE\" ON ((\"ASSOCIATIONTABLE\".pyAssociatedID = \"FACTTABLE\".pySub"
                        + "jectID) ) WHERE (\"ASSOCIATIONTABLE\".pySubjectID IN ('MPER8374849')) )  \"FACTTABLE\"  WHERE (\"FACTTABLE\".pxO"
                        + "utcomeTime >= {IHQueryPage.pzStartFrom DateTime})  ORDER BY 2 DESC",
                alertMessageReportEntryKey);
    }
}
